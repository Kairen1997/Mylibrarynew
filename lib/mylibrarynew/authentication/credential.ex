defmodule Mylibrarynew.Authentication.Credential do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Mylibrarynew.Repo)
  ...
  """
  def valid_password?(%Mylibrarynew.Authentication.Credential{hashed_password: hashed_password}, password)
