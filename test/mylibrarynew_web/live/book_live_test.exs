defmodule MylibrarynewWeb.BookLiveTest do
  use MylibrarynewWeb.ConnCase

  import Phoenix.LiveViewTest
  import Mylibrarynew.LibraryFixtures

  @create_attrs %{title: "some title", author: "some author", isbn: "some isbn", publised_at: "2025-07-15"}
  @update_attrs %{title: "some updated title", author: "some updated author", isbn: "some updated isbn", publised_at: "2025-07-16"}
