defmodule MylibrarynewWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use MylibrarynewWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint MylibrarynewWeb.Endpoint
      ...
      import MylibrarynewWeb.ConnCase
    end
  end

  setup tags do
    Mylibrarynew.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Mylibrarynew.AuthenticationFixtures.user_fixture()
  ...
  def register_and_log_in_credential(%{conn: conn}) do
    credential = Mylibrarynew.AuthenticationFixtures.credential_fixture()
  ...
  def log_in_credential(conn, credential) do
    token = Mylibrarynew.Authentication.generate_credential_session_token(credential)
